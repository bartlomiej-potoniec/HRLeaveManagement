...
using HRLeaveManagement.Application.Features.LeaveRequest.ApproveLeaveRequest.Events;
using MediatR;

namespace HRLeaveManagement.Application.Features.LeaveRequest.RejectLeaveRequest.Events;
