...
public abstract class WorkRequest
{
    ...
    protected async Task InitializeBase<TRequest>(Employee requestingEmployee,
                                                  DateOnly startedAt,
                                                  DateOnly endedAt,
                                                  Employee approver,
    ...
    private static async Task ValidateBaseRules<TRequest>(Employee requestingEmployee,
                                                          DateOnly startedAt,
                                                          DateOnly endedAt,
                                                          Employee approver,
                                                          IWorkRequestRuleSet workRequestRuleSet,
