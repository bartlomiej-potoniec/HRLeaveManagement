...
public class RemoteWorkLimit
{
    ...
    public static RemoteWorkLimit Create(EmployeeWithRemoteWorkLimits employee, int currentYear, int year, int availableDays)
    {
        var isRemoteWorkLimitForYearExist = employee.RemoteWorkLimits
