...
public sealed class DepartmentCreated(Department department) : IEntityEvent
{
    ...
    public string Content => $"Utworzono nowy dział nr: { DepartmentId } o nazwie: { DepartmentName }";
}
